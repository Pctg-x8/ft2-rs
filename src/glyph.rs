...
extern "system"
{
	pub fn FT_New_Glyph(library: FT_Library, format: FT_Glyph_Format, aglyph: *mut FT_Glyph) -> FT_Error;
...
extern "system"
{
	...
	pub fn FT_Glyph_To_Bitmap(the_glyph: *mut FT_Glyph, render_mode: FT_Render_Mode,
		origin: *mut FT_Vector, destroy: FT_Bool) -> FT_Error;
