...
pub type FT_Outline_MoveToFunc =
    extern "system" fn(to: *const FT_Vector, user: *mut c_void) -> c_int;
pub type FT_Outline_LineToFunc =
    extern "system" fn(to: *const FT_Vector, user: *mut c_void) -> c_int;
pub type FT_Outline_ConicToFunc =
    extern "system" fn(control: *const FT_Vector, to: *const FT_Vector, user: *mut c_void) -> c_int;
...
pub type FT_SpanFunc =
    extern "system" fn(y: c_int, count: c_int, spans: *const FT_Span, user: *mut c_void);

pub type FT_Raster_BitTest_Func =
    extern "system" fn(y: c_int, x: c_int, user: *mut c_void) -> c_int;
...
pub type FT_Raster_NewFunc =
    extern "system" fn(memory: *mut c_void, raster: *mut FT_Raster) -> c_int;
pub type FT_Raster_DoneFunc = extern "system" fn(raster: FT_Raster);
pub type FT_Raster_ResetFunc =
    extern "system" fn(raster: FT_Raster, pool_base: *mut c_uchar, pool_size: c_ulong);
pub type FT_Raster_SetModeFunc =
    extern "system" fn(raster: FT_Raster, mode: c_ulong, args: *mut c_void) -> c_int;
pub type FT_Raster_RenderFunc =
    extern "system" fn(raster: FT_Raster, params: *const FT_Raster_Params) -> c_int;
#[repr(C)]
