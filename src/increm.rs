...
pub type FT_Incremental_GetGlyphDataFunc = extern "system" fn(incremental: FT_Incremental,
	glyph_index: FT_UInt, adata: *mut FT_Data) -> FT_Error;
pub type FT_Incremental_FreeGlyphDataFunc = extern "system" fn(incremental: FT_Incremental,
	data: *mut FT_Data);
pub type FT_Incremental_GetGlyphMetricsFunc = extern "system" fn(incremental: FT_Incremental,
	glyph_index: FT_UInt, vertical: FT_Bool, ametrics: *mut FT_Incremental_MetricsRec) -> FT_Error;
#[repr(C)]
